...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QRect(10, 10, 491, 471))
        font = QFont()
        ...
        self.groupBox_6.setGeometry(QRect(520, 10, 431, 471))
        ...
        self.formLayoutWidget_7.setGeometry(QRect(10, 310, 411, 121))
        ...
        self.groupBox_2.setGeometry(QRect(540, 480, 391, 111))
        ...
        self.formLayoutWidget_10.setGeometry(QRect(10, 90, 351, 54))
        ...
        self.usdPathLable = QLabel(self.groupBox_4)
        self.usdPathLable.setObjectName(u"usdPathLable")
        self.usdPathLable.setGeometry(QRect(270, 60, 111, 21))
        self.usdPathLable.setFont(font4)
        self.headlessServerStatus = QLabel(self.groupBox_4)
        self.headlessServerStatus.setObjectName(u"headlessServerStatus")
        self.headlessServerStatus.setGeometry(QRect(270, 30, 111, 21))
        self.headlessServerStatus.setFont(font1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_4.setTitle(QCoreApplication.translate("MainWindow", u"Behaviour Streaming", None))
        ...
        self.usdPathLable.setText(QCoreApplication.translate("MainWindow", u".", None))
        self.headlessServerStatus.setText(QCoreApplication.translate("MainWindow", u".", None))
